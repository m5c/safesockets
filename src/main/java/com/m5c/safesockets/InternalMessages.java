...
public class InternalMessages
{
     ...
     *
     * @param message
     * @return whether the message matches the reserved patterns or not
     */
    public static boolean isReserved(String message)
    {
        return (message.startsWith(InternalMessages.MESSAGE_ACK) || message.startsWith(InternalMessages.HEART_BEAT_ACK) || message.startsWith(InternalMessages.HEART_BEAT) || message.startsWith(InternalMessages.MESSAGE_DELIMITER));
    }
